...
% by Yi Peng
%
% Output: [block_size1, block_size2, channel, block_num]  (Default)
%         [block_size1 * block_size2, channel, block_num] (Decouple)
%==========================================================================
...
% if mod(sz(1)-overlap_sz(1),block_sz(1)-overlap_sz(1))~=0 && ...  mod(sz(1:2) - overlap_sz, block_sz - overlap_sz)~= [0, 0]
%         mod(sz(2)-overlap_sz(2),block_sz(2)-overlap_sz(2))~=0
%     error('Data size cannot fit the patch size and step !!!');
% end
